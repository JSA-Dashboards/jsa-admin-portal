"""
ZFS (Zeeland Farm Services) cash-bid parser.

Converts per-location dicts from zfs_scraper.fetch_zfs_bids() into
NewSnapshotRequest objects.  All ZFS bids are Soybeans.
"""
...
def parse_zfs_location(loc: dict) -> Optional[NewSnapshotRequest]:
    """
    Convert one ZFS location dict into a NewSnapshotRequest.

    Args:
        loc: dict from zfs_scraper.fetch_zfs_bids():
