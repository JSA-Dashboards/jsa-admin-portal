"""
White River Soy cash-bid parser.
"""
...
def parse_whiteriver_location(loc: dict) -> Optional[NewSnapshotRequest]:
    ...
    for bid in bids:
        ...
        row_id = f"WRS_{bid_id}" if bid_id else f"WRS_{cme_sym}_{delivery.replace(' ','')}"
