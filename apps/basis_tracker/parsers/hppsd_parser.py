"""
High Plains Processing (HPPSD) cash-bid parser.
"""
...
def parse_hppsd_location(loc: dict) -> Optional[NewSnapshotRequest]:
    ...
    for bid in bids:
        ...
        row_id = f"HPP_{bid_id}" if bid_id else f"HPP_{cme_sym}_{delivery.replace(' ','')}"
