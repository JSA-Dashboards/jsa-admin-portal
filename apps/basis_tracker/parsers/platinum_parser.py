"""
Platinum Crush cash-bid parser.

Converts per-location dicts from platinum_scraper.fetch_platinum_bids()
into NewSnapshotRequest objects.  All bids are Soybeans.
"""
...
def parse_platinum_location(loc: dict) -> Optional[NewSnapshotRequest]:
