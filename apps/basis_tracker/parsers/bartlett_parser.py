"""
Bartlett Grain Company cash-bid parser.
"""
...
def parse_bartlett_location(loc: dict) -> Optional[NewSnapshotRequest]:
    ...
    for bid in bids:
        ...
        row_id = f"BRT_{bid_id}" if bid_id else f"BRT_{cme_sym}_{delivery.replace(' ', '')}"
