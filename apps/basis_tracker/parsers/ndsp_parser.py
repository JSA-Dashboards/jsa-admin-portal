"""
North Dakota Soybean Processors (NDSP) cash-bid parser.
"""
...
def parse_ndsp_location(loc: dict) -> Optional[NewSnapshotRequest]:
    ...
    for bid in bids:
        ...
        row_id = f"NDSP_{bid_id}" if bid_id else f"NDSP_{cme_sym}_{delivery.replace(' ', '')}"
